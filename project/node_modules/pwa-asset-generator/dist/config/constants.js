...
const apple_fallback_data_json_1 = __importDefault(require("./apple-fallback-data.json"));
const HTML_META_ORDERED_SELECTOR_LIST = [
    {
        name: meta_1.HTMLMetaNames.favicon,
        selector: 'link[rel="icon"]',
    },
    {
        name: meta_1.HTMLMetaNames.appleTouchIcon,
        selector: 'link[rel="apple-touch-icon"]',
    },
    {
        name: meta_1.HTMLMetaNames.appleMobileWebAppCapable,
        selector: 'meta[name="apple-mobile-web-app-capable"]',
    },
    {
        name: meta_1.HTMLMetaNames.appleLaunchImage,
        selector: 'link[rel="apple-touch-startup-image"]:not([media^="(prefers-color-scheme: dark)"])',
    },
    {
        name: meta_1.HTMLMetaNames.appleLaunchImageDarkMode,
...
exports.default = {
    ...
    APPLE_HIG_DEVICE_SCALE_FACTOR_SPECS_URL: 'https://developer.apple.com/design/human-interface-guidelines/ios/icons-and-images/image-size-and-resolution/',
    ...
    FAVICON_META_HTML: (size, url, mimeType) => `<link rel="icon" type="${mimeType}" sizes="${size}x${size}" href="${url}">
`,
...
<img src="${imgPath}">
    ...
    APPLE_TOUCH_ICON_META_HTML: (size, url) => `<link rel="apple-touch-icon" sizes="${size}x${size}" href="${url}">
`,
    APPLE_LAUNCH_SCREEN_META_HTML: (width, height, url, scaleFactor, orientation, darkMode) => {
        /* eslint-disable */
...
`;
    ...
    APPLE_HIG_SPLASH_SCREEN_FALLBACK_DATA: apple_fallback_data_json_1.default,
};
